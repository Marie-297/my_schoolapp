...
-- CreateIndex
CREATE UNIQUE INDEX "Teacher_address_key" ON "Teacher"("address");
...
-- AddForeignKey
ALTER TABLE "MidTerm" ADD CONSTRAINT "MidTerm_subjectId_fkey" FOREIGN KEY ("subjectId") REFERENCES "Subject"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "Result" ADD CONSTRAINT "Result_examId_fkey" FOREIGN KEY ("examId") REFERENCES "Exams"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "Result" ADD CONSTRAINT "Result_midtermId_fkey" FOREIGN KEY ("midtermId") REFERENCES "MidTerm"("id") ON DELETE SET NULL ON UPDATE CASCADE;
