...
export default function MidtermYearPage() {
  ...
  return (
    <div className="p-6">
      <h1 className="text-2xl font-bold mb-4">{decodedYear || "Unknown"} Academic Year</h1>
      {grades.length === 0 ? (
        ...
        <ul className="space-y-3">
          {grades.map((grade) => (
            ...
            >
              <Link
                href={`/lists/midterm/exams/${yearParam}/${grade.level
                .toString()
                .replace(/\s+/g, "-")
                .toLowerCase()}`}
